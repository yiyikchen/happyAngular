...
export declare abstract class AlainI18nBaseService implements AlainI18NService {
    ...
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AlainI18nBaseService, never>;
    static ɵprov: ɵngcc0.ɵɵInjectableDeclaration<AlainI18nBaseService>;
}
export declare class AlainI18NServiceFake extends AlainI18nBaseService {
    use(lang: string, data: Record<string, string>): void;
    getLangs(): NzSafeAny[];
    static ɵfac: ɵngcc0.ɵɵFactoryDeclaration<AlainI18NServiceFake, never>;
}
