...
ACLService.ɵfac = function ACLService_Factory(t) { return new (t || ACLService)(ɵngcc0.ɵɵinject(ɵngcc1.AlainConfigService)); };
ACLService.ɵprov = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjectable({ token: ACLService, factory: ACLService.ɵfac });
ACLService.ctorParameters = () => [
    { type: AlainConfigService }
];
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ACLService, [{
        type: Injectable
...
ACLIfDirective.ɵfac = function ACLIfDirective_Factory(t) { return new (t || ACLIfDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.TemplateRef), ɵngcc0.ɵɵdirectiveInject(ACLService), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ViewContainerRef)); };
ACLIfDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: ACLIfDirective, selectors: [["", "aclIf", ""]], inputs: { aclIf: "aclIf", aclIfThen: "aclIfThen", aclIfElse: "aclIfElse", except: "except" }, exportAs: ["aclIf"] });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ACLIfDirective, [{
        type: Directive,
        args: [{
                selector: '[aclIf]',
                exportAs: 'aclIf'
            }]
    }], function () { return [{ type: ɵngcc0.TemplateRef }, { type: ACLService }, { type: ɵngcc0.ViewContainerRef }]; }, { aclIf: [{
            type: Input
        }], aclIfThen: [{
            type: Input
        }], aclIfElse: [{
...
ACLDirective.ɵfac = function ACLDirective_Factory(t) { return new (t || ACLDirective)(ɵngcc0.ɵɵdirectiveInject(ɵngcc0.ElementRef), ɵngcc0.ɵɵdirectiveInject(ɵngcc0.Renderer2), ɵngcc0.ɵɵdirectiveInject(ACLService)); };
ACLDirective.ɵdir = /*@__PURE__*/ ɵngcc0.ɵɵdefineDirective({ type: ACLDirective, selectors: [["", "acl", ""]], inputs: { acl: "acl", ability: ["acl-ability", "ability"] }, exportAs: ["acl"] });
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ACLDirective, [{
        type: Directive,
        args: [{
                selector: '[acl]',
                exportAs: 'acl'
            }]
    }], function () { return [{ type: ɵngcc0.ElementRef }, { type: ɵngcc0.Renderer2 }, { type: ACLService }]; }, { acl: [{
            type: Input,
            args: ['acl']
        }], ability: [{
            type: Input,
...
ACLGuard.ɵfac = function ACLGuard_Factory(t) { return new (t || ACLGuard)(ɵngcc0.ɵɵinject(ACLService), ɵngcc0.ɵɵinject(ɵngcc2.Router)); };
...
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(ACLGuard, [{
        type: Injectable,
        args: [{ providedIn: 'root' }]
    }], function () { return [{ type: ACLService }, { type: ɵngcc2.Router }]; }, null); })();
...
DelonACLModule.ɵfac = function DelonACLModule_Factory(t) { return new (t || DelonACLModule)(); };
DelonACLModule.ɵmod = /*@__PURE__*/ ɵngcc0.ɵɵdefineNgModule({ type: DelonACLModule });
DelonACLModule.ɵinj = /*@__PURE__*/ ɵngcc0.ɵɵdefineInjector({ imports: [[CommonModule]] });
(function () { (typeof ngDevMode === "undefined" || ngDevMode) && ɵngcc0.ɵsetClassMetadata(DelonACLModule, [{
        type: NgModule,
        args: [{
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && ɵngcc0.ɵɵsetNgModuleScope(DelonACLModule, { declarations: function () { return [ACLDirective, ACLIfDirective]; }, imports: function () { return [CommonModule]; }, exports: function () { return [ACLDirective, ACLIfDirective]; } }); })();
